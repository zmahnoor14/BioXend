...
| Template Column | Maps to | Required | Auto-filled by BioXend | Description |
|----------------|---------|----------|------------------------|-------------|
| `assay_identifier` | `AIDX` | **Mandatory** | Yes (if left empty) | Unique assay identifier; auto-generated by BioXend if not provided — or supply your own |
...
| `TARGET_ORGANISM` | `TARGET_ORGANISM` | Recommended | Yes (from `Bacteria_scientific_name`) | Auto-filled from scientific name if not provided |
